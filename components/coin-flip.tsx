...
export default function CoinFlip() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="h-6">
        {result && !isFlipping && <p className="text-lg font-semibold capitalize">{result}!</p>}
      </div>
      <Button onClick={flipCoin} disabled={isFlipping} className="bg-yellow-500 hover:bg-yellow-600 text-white">
