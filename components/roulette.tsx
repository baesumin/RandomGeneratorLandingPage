  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="relative">
        <canvas ref={canvasRef} width={200} height={200} className="border rounded-full" />
      </div>

      <div className="h-6">{result && !spinning && <p className="text-lg font-semibold">Result: {result}</p>}</div>

      <Button onClick={spinWheel} disabled={spinning} className="bg-purple-500 hover:bg-purple-600 text-white">
